...
# Date: 2025-03-05 (W)
# Description: This script reshapes the data for the GAMM analysis
#
# Usage:
...
# Preprocessing the data for the GAMM analysis
# Rename seg_End
...
slz_h1h2c_trans$measurement_no <- str_sub(slz_h1h2c_trans$variable,-2,-1)
...
slz_h1c_trans$measurement_no  <-  str_sub(slz_h1c_trans$variable,-2,-1)
...
slz_h2c_trans$measurement_no  <-  str_sub(slz_h2c_trans$variable,-2,-1)
...
slz_h4c_trans$measurement_no  <-  str_sub(slz_h4c_trans$variable,-2,-1)
...
slz_h2h4c_trans$measurement_no  <-  str_sub(slz_h2h4c_trans$variable,-2,-1)
...
slz_h1a1c_trans$measurement_no  <-  str_sub(slz_h1a1c_trans$variable,-2,-1)
...
slz_h1a2c_trans$measurement_no  <-  str_sub(slz_h1a2c_trans$variable,-2,-1)
...
slz_h1a3c_trans$measurement_no  <-  str_sub(slz_h1a3c_trans$variable,-2,-1)
...
slz_h42Kc_trans$measurement_no  <-  str_sub(slz_h42Kc_trans$variable,-2,-1)
...
slz_h2Kh5Kc_trans$measurement_no  <-  str_sub(slz_h2Kh5Kc_trans$variable,-2,-1)
...
slz_cpp_trans$measurement_no  <-  str_sub(slz_cpp_trans$variable,-2,-1)
...
slz_energy_trans$measurement_no  <-  str_sub(slz_energy_trans$variable,-2,-1)
...
slz_hnr05_trans$measurement_no  <-  str_sub(slz_hnr05_trans$variable,-2,-1)
...
slz_hnr15_trans$measurement_no  <-  str_sub(slz_hnr15_trans$variable,-2,-1)
...
slz_hnr25_trans$measurement_no  <-  str_sub(slz_hnr25_trans$variable,-2,-1)
...
slz_hnr35_trans$measurement_no  <-  str_sub(slz_hnr35_trans$variable,-2,-1)
...
slz_strF0_trans$measurement_no  <-  str_sub(slz_strF0_trans$variable,-2,-1)
...
slz_sF1_trans$measurement_no  <-  str_sub(slz_sF1_trans$variable,-2,-1)
...
slz_sF2_trans$measurement_no  <-  str_sub(slz_sF2_trans$variable,-2,-1)
...
slz_sB1_trans$measurement_no  <-  str_sub(slz_sB1_trans$variable,-2,-1)
...
slz_sB2_trans$measurement_no  <-  str_sub(slz_sB2_trans$variable,-2,-1)
...
slz_shr_trans$measurement_no  <-  str_sub(slz_shr_trans$variable,-2,-1)
...
slz_soe_trans$measurement_no  <-  str_sub(slz_soe_trans$variable,-2,-1)
...
slz_a1_trans$measurement_no  <-  str_sub(slz_a1_trans$variable,-2,-1)
...
slz_a2_trans$measurement_no  <-  str_sub(slz_a2_trans$variable, -2, -1)
...
slz_a3_trans$measurement_no  <-  str_sub(slz_a3_trans$variable, -2, -1)
...
slz_trans <-  list(slz_h1h2c_trans,
                   ...
                   slz_a1_trans,
                   slz_a2_trans,
                   slz_a3_trans) %>% reduce(merge, by = c("idnum","measurement_no"))
